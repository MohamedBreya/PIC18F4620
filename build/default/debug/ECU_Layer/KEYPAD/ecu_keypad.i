...
# 11 "ECU_Layer/KEYPAD/../../MCAL_Layer/GPIO/../compilar.h"
...
# 11 "ECU_Layer/KEYPAD/../../MCAL_Layer/GPIO/../compilar.h" 2
...
# 31 "ECU_Layer/KEYPAD/ecu_keypad.h"
typedef struct {
...
# 37 "ECU_Layer/KEYPAD/ecu_keypad.c"
Std_ReturnType keypad_get_value (const keypad_t *_keypad_opj, uint8 *value)
{
    Std_ReturnType ret = (Std_ReturnType)0x01;
    uint8 rows_counter = 0, columns_counter = 0 ;

    if((((void*)0) == _keypad_opj) || (((void*)0) == value))
    {
        ret = (Std_ReturnType)0x00;
    }
    else
