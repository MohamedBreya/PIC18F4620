...
# 13 "MCAL_Layer/Timers/hal_timer0.h"
...
# 48 "MCAL_Layer/Timers/hal_timer0.h"
typedef enum
{
...
# 1 "MCAL_Layer/Timers/hal_timer0.c" 2
    ...
    static InterruptHandeler TMR0_Interrupt_Handeler = ((void*)0);
...
# 62 "MCAL_Layer/Timers/hal_timer0.c"
                (INTCONbits.GIE=1);
                (INTCONbits.PEIE=1);
...
# 102 "MCAL_Layer/Timers/hal_timer0.c"
Std_ReturnType Timer0_Write_Value(const timer0_t *_timer, uint16 _value)
{
    Std_ReturnType ret = (Std_ReturnType)0x01;
...
# 125 "MCAL_Layer/Timers/hal_timer0.c"
Std_ReturnType Timer0_Read_Value(const timer0_t *_timer, uint16 *_value)
{
    Std_ReturnType ret = (Std_ReturnType)0x01;
    uint8 l_tmr0_l = 0;
